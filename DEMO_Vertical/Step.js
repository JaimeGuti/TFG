var position_desp_step = '27 25 -25';
var position_scaled_step = '27 20 -25';
var position_inv_step = '27 15 -25';
var position_high_step = '27 10 -25';
var position_neg_step = '27 5 -25';
...
/*                         if (mod_inv != 0) {
            ...
            // número aleatorio entre -60 y 100
            var minlimit = -60;
            var numeroAleatorio = Math.floor(Math.random() * (100 - (-50) + 1)) + (minlimit);
            
            mod_high = mod_high + numeroAleatorio;
            if ((mod_high <= -60) || (mod_high >= 40)) {
                mod_high = 0;
                numeroAleatorio = 0;
            }
        });
