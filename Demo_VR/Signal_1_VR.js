var position_desp_signal_1 = '8.5 5 17.25';
var position_scaled_signal_1 = '8.5 2 17.25';
var position_inv_signal_1 = '6.25 5 17.25';
var position_high_signal_1 = '6.25 2 17.25';
var position_neg_signal_1 = '4 5 17.25';
...
AFRAME.registerComponent('draw-signal_1', {
    ...
    init: function () {
        ...
        el.addEventListener('mousedown', function () {
            ...
            this.canvas = document.querySelector("#signal1canvas");
...
AFRAME.registerComponent('desp-signal_1', {
    schema: {
        width: {default: 2},
        height: {default: 1},
        depth: {default: 0.25},
    ...
    init: function () {
        ...
        el.addEventListener('mousedown', function () {
            ...
            // generate random number between -100 to 230
            var minlimit = -100;
            var maxlimit = 230;
...
AFRAME.registerComponent('scaled-signal_1', {
    schema: {
        width: {default: 2},
        height: {default: 1},
        depth: {default: 0.25},
    ...
    init: function () {
        ...
        el.addEventListener('mousedown', function () {
            ...
            // generate random number between -20 to 50
            var minlimit = -20;
            var maxlimit = 50;
            var randomNum = Math.floor(Math.random() * (maxlimit)) + (minlimit);
            // console.log("Random number = " + randomNum);
            ...
            if ((mod_scaled < -13) || (mod_scaled > 50)) {
                mod_scaled = 0;
                randomNum = 0;
            }
...
AFRAME.registerComponent('inv-signal_1', {
    schema: {
        width: {default: 2},
        height: {default: 1},
        depth: {default: 0.25},
...
AFRAME.registerComponent('high-signal_1', {
    schema: {
        width: {default: 2},
        height: {default: 1},
        depth: {default: 0.25},
...
AFRAME.registerComponent('neg-signal_1', {
    schema: {
        width: {default: 2},
        height: {default: 1},
        depth: {default: 0.25},
